...
<body>
<form action="enterprise/logon" method="post" id="Form1" name="Form1" onsubmit="return submitForm1();">
    <div class="wapbg">
        <div class="wap">
            <div class="top"><img style="padding-top:80px" src="${base}image/qyddlym.png" width="474px" height="61px"></div>
            <div class="middle">
                <div class="dl"><div class="dlti">登录企业中心</div>
                    <div class="dlmi">
                        <p>手机号:</p>
                        <input style="position:absolute; top:7px;" name="hr_tel" 　id="xh" type="text">
                        <p>密码:</p>
                        <input style="position:absolute; top:54px;" name="password" id="pwd" type="password">
                        <br>
                    </div>
                    <br>
                ...
                <div class="end">
                    <a href="enterprise/register">注册企业账号</a>
                </div>
            </div>
        </div>
    </div>
